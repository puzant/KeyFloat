export const numbersMacLayout = [
  { num: "`", ar: [], fr: ["#"], sp: [], am: [""], eventName: "Backquote" },
  { num: "1", ar: [], fr: ["&"], sp: [], am: ["։"], eventName: "Digit1" },
  { num: "2", ar: [], fr: ["é"], sp: [], am: ["ձ"], eventName: "Digit2" },
  { num: "3", ar: [], fr: [""], sp: [], am: ["յ"], eventName: "Digit3" },
  { num: "4", ar: [], fr: ["'"], sp: [], am: ["՛"], eventName: "Digit4" },
  { num: "5", ar: [], fr: [""], sp: [], am: [","], eventName: "Digit5" },
  { num: "6", ar: [], fr: ["§"], sp: [], am: ["-"], eventName: "Digit6" },
  { num: "7", ar: [], fr: ["è"], sp: [], am: ["."], eventName: "Digit7" },
  { num: "8", ar: [], fr: ["!"], sp: [], am: ["«"], eventName: "Digit8" },
  { num: "9", ar: [], fr: ["ç"], sp: [], am: ["»"], eventName: "Digit9" },
  { num: "0", ar: [], fr: ["à"], sp: [], am: ["օ"], eventName: "Digit0" },
];

export const numbersWindowsLayout = [
  { num: "`", ar: [" ّ", "ذ"], fr: ["²"], sp: ["º"], am: [], eventName: "Backquote" },
  { num: "1", ar: [], fr: ["&"], sp: [], am: ["է"], eventName: "Digit1" },
  { num: "2", ar: [], fr: ["é"], sp: [], am: ["թ"], eventName: "Digit2" },
  { num: "3", ar: [], fr: [""], sp: [], am: ["փ"], eventName: "Digit3" },
  { num: "4", ar: [], fr: ["'"], sp: [], am: ["ձ"], eventName: "Digit4" },
  { num: "5", ar: [], fr: [""], sp: [], am: ["ջ"], eventName: "Digit5" },
  { num: "6", ar: [], fr: ["-"], sp: [], am: ["ւ"], eventName: "Digit6" },
  { num: "7", ar: [], fr: ["è"], sp: [], am: ["և"], eventName: "Digit7" },
  { num: "8", ar: [], fr: ["_"], sp: [], am: ["ր"], eventName: "Digit8" },
  { num: "9", ar: [], fr: ["ç"], sp: [], am: ["չ"], eventName: "Digit9" },
  { num: "0", ar: [], fr: ["à"], sp: [], am: ["ճ"], eventName: "Digit0" },
  { num: "-", ar: [], fr: [], sp: ["¿"], am: [], eventName: "Minus" },
  { num: "=", ar: [], fr: [], sp: ["?"], am: ["ժ"], eventName: "Equal" },
];
